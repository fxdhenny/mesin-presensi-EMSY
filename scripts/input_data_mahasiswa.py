...
def eksekusi_seeder():
    ...
    if not os.path.exists(DB_PATH):
        print("[-] Error: Database attendance.db belum ditemukan. Jalankan init_db.py terlebih dahulu.")
        return
    ...
    print("[*] Memulai proses input data mahasiswa...")
    ...
    print(f"[+] Proses Selesai! {berhasil} data mahasiswa berhasil diinput.")
    if dilewati > 0:
        print(f"[*] {dilewati} data dilewati karena NIM tersebut sudah terdaftar di database.")
